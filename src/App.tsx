 ...
 return (
  <div>
   ...
   <div className="relative h-[50vh] bg-cover bg-center flex flex-col align-center items-center justify-center bg-[url('/stardew-day.jpg')] shadow-lg">
    ...
    <h1 className="z-2 relative text-white text-3xl md:text-5xl lg:text-6xl drop-shadow-lg border-none">
    ...
    <div className="relative flex flex-col gap-4 md:gap-2 items-center justify-center mt-6 md:mt-2 p-4">
     ...
     <label
      htmlFor="file"
      className="z-2 backdrop-blur-xs cursor-pointer inline-block border border-dotted border-white p-6 m-4 w-48 bg-gradient-to-tr from-[#008c6c4f] to-[#084b8b52] text-white shadow-lg text-center text-xl rounded"
     >
      Select Save File
     </label>
     <input
